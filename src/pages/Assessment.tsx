...
const Assessment = () => {
  ...
  // Check if user is logged in and if registration and test are already completed
  useEffect(() => {
  ...
  const startRegistration = () => {
    if (!isLoggedIn) {
      toast({
        ...
        description: "Please login or register to start the assessment process.",
        variant: "destructive"
      });
      return;
    }
  ...
  const startAptitudeTest = () => {
    if (!isLoggedIn) {
      toast({
        title: "Login Required",
        description: "Please login or register to take the aptitude test.",
        variant: "destructive"
      });
      return;
    }
  ...
  const viewRecommendations = () => {
    if (!isLoggedIn) {
      toast({
        title: "Login Required",
        description: "Please login or register to view career recommendations.",
        variant: "destructive"
      });
      return;
    }
        ...
        <div className="mt-12 p-6 bg-career-lightpurple rounded-lg">
          <div className="flex items-start space-x-4">
            ...
            <div>
              ...
              {!isLoggedIn && (
                <div className="mt-4">
                  <p className="font-medium text-career-blue mb-2">To get started:</p>
                  <ul className="list-disc list-inside text-gray-700 space-y-1">
                    <li>Create an account or login above</li>
